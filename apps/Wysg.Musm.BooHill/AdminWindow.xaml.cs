...
public sealed class AdminWindow : Window
{
    ...
    public AdminWindow()
    {
        _filters.SortDirection = SortDirection.Descending;
        BuildLayout();
    }
    ...
    {
        if (_filters.SortField == field)
        {
            _filters.SortDirection = _filters.SortDirection == SortDirection.Ascending
                ? SortDirection.Descending
                : SortDirection.Ascending;
        }
        else
        {
            _filters.SortField = field;
            _filters.SortDirection = SortDirection.Ascending;
        }
    }
