...
2. Send Preview
3. Send
4. **Edit Tech** ¡ç NEW LOCATION
5. **Edit Comp** ¡ç NEW LOCATION
6. Phrases
7. Preorder
8. Test

### Button Labels
- "Edit Study Technique" ¡æ **"Edit Tech"** (shortened for space)
- "Edit Comparison" ¡æ **"Edit Comp"** (shortened for space)
...
- Consistent with workflow: Send ¡æ Edit metadata ¡æ Work with content
