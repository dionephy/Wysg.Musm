...
```
Browser Window:
  ? UseName=True ¡ç PROBLEM! Title changes with tabs
  ? UseClassName=True
...
```
Browser Window:
  ? UseName=False ¡ç FIXED! Ignores dynamic titles
  ? UseClassName=True ¡ç Structural match
  ? UseControlTypeId=True ¡ç Stable identifier
```
...
### Expected Results
```
Step 1: ClassName='Chrome_WidgetWin_1' ¡æ Match ?
Step 2: ClassName='BrowserRootView' ¡æ Match ?
...
Step 14: AutomationId='job-report-view-report-text' ¡æ Match ?
...
¡æ Re-capture with "Pick Web" button
```
...
- Full bugfix documentation: `BUGFIX_2025-02-10_WebBrowserElementPickerRobustness.md`
- Original feature: `ENHANCEMENT_2025-02-10_WebBrowserElementPicker.md`
