...
Check if Modality in Exclusion List?
    ¦§¦¡ Yes ¡æ Use "SendReportWithoutHeader"
    ¦¦¦¡ No  ¡æ Use "SendReport"
        ¡é
...
### Settings Location
**Automation Tab ¡æ "Following modalities don't send header" textbox**
...
- Saved when user clicks Save in Settings ¡æ Automation tab
...
- ENHANCEMENT_2025-02-10_SendReportWithoutHeader.md: SendReportWithoutHeader method addition
