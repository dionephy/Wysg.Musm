...
弛 Hook Callback Execution                             弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 1. Key detection          : ~0.5ms                  弛
弛 2. ShouldTriggerAutofocus : ~2ms (cached bookmark)  弛
弛 3. GetCharFromKey         : ~0.1ms                  弛
弛 4. Dispatcher.Invoke      : ~0.5ms (synchronous)    弛
弛    戍式 Focus callback      : ~5ms                    弛
弛    戌式 SendKeys.SendWait   : ~5ms                    弛
弛 5. Return to hook         : ~0.1ms                  弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 Total Latency             : ~13ms                   弛
...
- `CRITICAL_FIX_2025-02-11_KeyConsumptionAndDelivery.md` - Main fix document
- `CRITICAL_FIX_2025-02-11_EditorAutofocusBookmarkCaching.md` - Bookmark optimization
- `SUMMARY_2025-02-11_EditorAutofocusComplete.md` - Feature overview
