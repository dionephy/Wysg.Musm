...
3. **Location:** SpyWindow ¡æ Custom Procedures ¡æ PACS Methods
...
- ENHANCEMENT_2025-02-10_SendReportWithoutHeader.md (detailed change log)
- Spec.md FR-1190 to FR-1198 (updated specifications)
- ENHANCEMENT_2025-02-09_SendReportRetryLogic.md (original retry logic implementation)
