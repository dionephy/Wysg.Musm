...
3. **PhraseSemanticTags** - dictionary mapping phrase ¡æ SNOMED semantic tag
4. **Semantic tag ¡æ color mapping** - different colors for different medical concept types
