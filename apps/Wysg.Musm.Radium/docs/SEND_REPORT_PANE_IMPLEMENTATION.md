...
**Visual Arrangement:**
```
忙式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式成式式式式式式式式式式式式式忖
弛  New Study    弛  Add Study    弛  Available  弛
弛               弛               弛  Modules    弛
戍式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式扣  (Library)  弛
弛 Shortcut:     弛 Shortcut:     弛             弛
弛 Open (new)    弛 Open (add)    弛             弛
戍式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式扣             弛
弛 Send Report   弛 Shortcut:     弛             弛
弛  [NEW]        弛 Open (after)  弛             弛
戌式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式戎
```
