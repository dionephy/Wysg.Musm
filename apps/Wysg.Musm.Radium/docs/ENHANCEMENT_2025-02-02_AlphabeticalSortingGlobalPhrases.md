...
Phrases displayed by most recently updated:
  1. chest pain      (updated 2025-02-01)
...
¡æ Sees phrases in random order based on update time
¡æ Must scroll through entire list or use search
```

**After (alphabetical):**
```
User opens Global Phrases tab
¡æ Sees phrases starting with 'A'
¡æ Scrolls down to 'C' section
¡æ Finds "chest pain" quickly
```
...
| List | Sort Order |
|------|------------|
| **Global Phrases** | ? Alphabetical A-Z (as of 2025-02-02) |
...
With Case-Sensitive Sort:
  - Artery
  - aortic dissection  ¡ç All lowercase come after uppercase
  - bilateral
  - Chest pain
...
With Case-Insensitive Sort (chosen):
  ...
  - Artery
  - bilateral
  - Chest pain      ¡ç Natural grouping regardless of case
```
