...
1. **Dynamic Window Titles** - Browser window names change with tabs (e.g., "ITR Worklist Report - 개인 - Microsoft? Edge" vs "ITR Worklist Report - Microsoft Edge")
...
Actual element: Name='ITR Worklist Report - 개인 - Microsoft? Edge' (different!)
