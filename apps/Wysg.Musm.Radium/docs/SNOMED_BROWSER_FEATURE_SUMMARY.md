...
**Feature ID:** FR-SNOMED-BROWSER-2025-01-20  
...
弛                    SNOMED Browser Window                     弛
弛  忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖  弛
弛  弛           SnomedBrowserViewModel                      弛  弛
弛  弛  - CurrentPage, TotalPages                            弛  弛
弛  弛  - SelectedDomain                                     弛  弛
弛  弛  - Concepts: ObservableCollection                     弛  弛
弛  弛  - LoadConceptsAsync()                                弛  弛
弛  弛  - IsPhraseExistsAsync()                              弛  弛
弛  弛  - AddTermAsPhraseAsync()                             弛  弛
弛  戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎  弛
弛           弛                       弛                          弛
弛           ∪                       ∪                          弛
弛  忙式式式式式式式式式式式式式式式式式式忖    忙式式式式式式式式式式式式式式式式式式忖              弛
弛  弛SnowstormClient   弛    弛 SnomedMapService 弛              弛
弛  弛- SearchConcepts  弛    弛- CacheConceptAsync弛              弛
弛  弛- BrowseByTag     弛    弛- MapPhraseAsync  弛              弛
弛  戌式式式式式式式式式式式式式式式式式式戎    戌式式式式式式式式式式式式式式式式式式戎              弛
戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
                  弛                       弛
                  ∪                       ∪
         忙式式式式式式式式式式式式式式式式忖      忙式式式式式式式式式式式式式式式式忖
         弛  Snowstorm API 弛      弛  Azure SQL DB  弛
         弛  (ECL Queries) 弛      弛  (Phrase+Map)  弛
         戌式式式式式式式式式式式式式式式式戎      戌式式式式式式式式式式式式式式式式戎
```
...
弛  SNOMED CT Browser                                    [X]  弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛  Select Domain:                                            弛
弛  ∞ All  ≒ Body Structure  ∞ Finding  ∞ Disorder ...        弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛  ? Previous   Page 3 of 100   Next ?    Jump to: [5] Go   弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛  忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖  弛
弛  弛 [10200004] Liver structure (body structure)    ??   弛  弛
弛  弛  忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖 弛  弛
弛  弛  弛 PT      弛 Liver                        [Add]   弛 弛  弛
弛  弛  弛 FSN     弛 Liver structure (body...)    [Add]   弛 弛  弛
弛  弛  弛 Synonym 弛 Hepatic structure            [Add]   弛 弛  弛
弛  弛  戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎 弛  弛
弛  戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎  弛
弛  忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖  弛
弛  弛 [80891009] Heart structure (body structure)    ??   弛  弛
弛  弛  忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖 弛  弛
弛  弛  弛 PT      弛 Heart                        ? Added 弛 弛  弛
弛  弛  弛 FSN     弛 Heart structure (body...)    ? Added 弛 弛  弛
弛  弛  戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎 弛  弛
弛  戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎  弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛  Status: Loaded 10 concepts (23 terms) on page 3          弛
弛                                              [Refresh]     弛
