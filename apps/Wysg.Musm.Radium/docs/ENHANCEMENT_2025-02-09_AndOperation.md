# Enhancement: New Custom Procedure Operation - And (2025-02-09)
...
IsMatch(var1, "expected1") ¡æ var2

GetText(Field2) ¡æ var3
IsMatch(var3, "expected2") ¡æ var4

And(var2, var4) ¡æ var5
Result: var5 = "true" only if both fields match
```

### 2. Validate Multiple Visibility Conditions
```
IsVisible(Element1) ¡æ var1
IsVisible(Element2) ¡æ var2
And(var1, var2) ¡æ var3
Result: var3 = "true" only if both elements visible
```

### 3. Gate Automation Step
```
IsMatch(PatientNumber, var1) ¡æ var2
IsMatch(StudyDateTime, var3) ¡æ var4
And(var2, var4) ¡æ var5
...
```
WorklistIsVisible ¡æ var1
PatientNumberMatch ¡æ var2
And(var1, var2) ¡æ var3
...
```
Operation: IsMatch      Arg1: var1 (Var)  Arg2: "expected" (String) ¡æ var2
Operation: IsMatch      Arg1: var3 (Var)  Arg2: "expected2" (String) ¡æ var4
Operation: And          Arg1: var2 (Var)  Arg2: var4 (Var) ¡æ var5
Result: var5 = "true" if both validations pass
```

### Pattern 2: Visibility Gate
```
Operation: IsVisible    Arg1: Button1 (Element) ¡æ var1
Operation: IsVisible    Arg1: Button2 (Element) ¡æ var2
Operation: And          Arg1: var1 (Var)  Arg2: var2 (Var) ¡æ var3
Result: var3 = "true" if both buttons visible
```

### Pattern 3: Multi-Step Condition
```
Operation: PatientNumberMatch ¡æ var1
Operation: StudyDateTimeMatch ¡æ var2
Operation: And          Arg1: var1 (Var)  Arg2: var2 (Var) ¡æ var3
...
```
Operation: Condition1 ¡æ var1
Operation: Condition2 ¡æ var2
Operation: And          Arg1: var1 (Var)  Arg2: var2 (Var) ¡æ var3
Operation: Condition3 ¡æ var4
Operation: And          Arg1: var3 (Var)  Arg2: var4 (Var) ¡æ var5
...
### Truth Table Details
```
And("true", "true") ¡æ "true"
And("True", "TRUE") ¡æ "true"
And("true", "false") ¡æ "false"
And("true", "") ¡æ "false"
And("true", null) ¡æ "false"
And("false", "false") ¡æ "false"
And("", "") ¡æ "false"
And("yes", "yes") ¡æ "false"  # Only "true" string is recognized
```
...
### With IsAlmostMatch
```
IsAlmostMatch(var1, "fuzzy1") ¡æ var2
IsAlmostMatch(var3, "fuzzy2") ¡æ var4
And(var2, var4) ¡æ var5
```

### With PACS Methods
```
PatientNumberMatch ¡æ var1
StudyDateTimeMatch ¡æ var2
And(var1, var2) ¡æ var3
```
...
Condition3 ¡æ var4
And(var3, var4) ¡æ var5  # Result of first AND with third condition
```
...
IsVisible(SaveButton) ¡æ isSaveButtonVisible
IsVisible(CancelButton) ¡æ isCancelButtonVisible
And(isSaveButtonVisible, isCancelButtonVisible) ¡æ bothButtonsVisible

# Good: Chain multiple conditions
CheckA ¡æ resultA
CheckB ¡æ resultB
And(resultA, resultB) ¡æ combinedAB
CheckC ¡æ resultC
And(combinedAB, resultC) ¡æ finalResult
```

### ? Don't:
```
# Bad: Using with non-boolean values
GetText(Field) ¡æ var1  # Returns text, not boolean
...
### Null/Empty Handling
- Null converted to empty string ¡æ false
- Empty string ¡æ false
...
Step 1: GetText         Arg1: Field1 (Element) ¡æ var1
Step 2: IsMatch         Arg1: var1 (Var)  Arg2: "expected1" (String) ¡æ var2
Step 3: GetText         Arg1: Field2 (Element) ¡æ var3
Step 4: IsMatch         Arg1: var3 (Var)  Arg2: "expected2" (String) ¡æ var4
Step 5: And             Arg1: var2 (Var)  Arg2: var4 (Var) ¡æ var5
...
Step 1: PatientNumberMatch ¡æ var1
Step 2: StudyDateTimeMatch ¡æ var2
Step 3: And             Arg1: var1 (Var)  Arg2: var2 (Var) ¡æ var3
...
Step 1: IsVisible       Arg1: SaveButton (Element) ¡æ var1
Step 2: IsVisible       Arg1: SendButton (Element) ¡æ var2
Step 3: IsVisible       Arg1: CloseButton (Element) ¡æ var3
Step 4: And             Arg1: var1 (Var)  Arg2: var2 (Var) ¡æ var4
Step 5: And             Arg1: var4 (Var)  Arg2: var3 (Var) ¡æ var5
...
Step 1: GetText         Arg1: PatientField (Element) ¡æ var1
Step 2: IsMatch         Arg1: var1 (Var)  Arg2: "12345678" (String) ¡æ var2

Step 3: WorklistIsVisible ¡æ var3

Step 4: And             Arg1: var2 (Var)  Arg2: var3 (Var) ¡æ var4

Step 5: GetText         Arg1: StudyField (Element) ¡æ var5
Step 6: IsMatch         Arg1: var5 (Var)  Arg2: "CT Brain" (String) ¡æ var6

Step 7: And             Arg1: var4 (Var)  Arg2: var6 (Var) ¡æ var7
Result: var7 = "true" if patient matches AND worklist visible AND study matches
```

## Testing Recommendations
1. Test with both true inputs ¡æ expect "true"
2. Test with one false input ¡æ expect "false"
3. Test with both false inputs ¡æ expect "false"
4. Test with empty string inputs ¡æ expect "false"
5. Test with null inputs ¡æ expect "false"
6. Test case variations ("True", "TRUE") ¡æ expect "true"
7. Test with non-"true" strings ¡æ expect "false"
