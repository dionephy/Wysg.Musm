...
戍式 Everything in one place
戌式 Hard to navigate, slow to load
```
...
戍式 Module dispatcher
戌式 Automation modules

MainViewModel.Commands.AddPreviousStudy.cs (450 lines)
戍式 AddPreviousStudy
戌式 Comparison update
...
```markdown
## 2025-02-09 - Refactoring: Split MainViewModel.Commands.cs
...
**Related Documents**:
- `apps/Wysg.Musm.Radium/docs/REFACTOR_2025-02-09_SplitCommandsFile.md` - Initial planning
- `apps/Wysg.Musm.Radium/docs/ENHANCEMENT_2025-02-09_AddPreviousStudyComparisonUpdate.md` - Comparison update feature
