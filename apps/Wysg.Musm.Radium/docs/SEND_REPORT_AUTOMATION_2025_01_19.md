...
- [x] Added 3 new automation panes to Settings �� Automation tab
...
**Location**: `MainViewModel.Commands.cs` �� `RunModulesSequentially()`
...
- [ ] Click "Send Report Preview" button �� configured modules execute
- [ ] Press Send Report hotkey with Reportified OFF �� preview sequence executes
- [ ] Press Send Report hotkey with Reportified ON �� reportified sequence executes
- [ ] Add Reportify to a sequence �� toggle turns ON when module executes
- [ ] Empty sequence �� status shows "not configured"
- [ ] Reportify + SendReport sequence �� report transforms then sends

### Example Workflow Scenarios

**Scenario 1: Quick Preview Send**
```
Settings �� Automation �� Send Report Preview:
  - SendReport
...
```
Settings �� Automation �� Shortcut: Send Report (reportified):
  - Reportify
  - SendReport
...
User Actions:
  - Reportified OFF + hotkey �� Quick send
  - Reportified ON + hotkey �� Format, reposition screens, then send
```
...
### System Design
- **Separation of Concerns**: UI (panes) �� Data (ViewModel) �� Logic (Commands) �� Persistence (JSON)
...
1. ? **3 New Automation Panes** in Settings �� Automation tab
