...
- **Pattern**: Copy ON ? Auto OFF
  - When Copy turns ON �� Auto turns OFF
  - When Auto turns ON �� Copy turns OFF
...
- ? Copy toggle ON �� Study Remark copied
- ? Copy toggle OFF �� Study Remark NOT copied
- ? Copy ON �� Auto turns OFF
- ? Auto ON �� Copy turns OFF
