...
������������������������������������������������������������������������������������������������������������������������������
         ...
         ��������������������������������������������������������������������������������
                    ...
                    YES             NO �� CallNextHookEx (pass through)
                      ��
    ������������������������������������������������������������������������������������
    ��  Step 1: Check if Radium has focus     ��
    ��  GetForegroundWindow() == radiumHwnd?  ��
    ������������������������������������������������������������������������������������
             ��                     ��
           YES �� skip            NO �� continue
                                   ��
    ������������������������������������������������������������������������������������
    ��  Step 2: Check key type enabled        ��
    ��  IsKeyTypeEnabled(key)?                ��
    ������������������������������������������������������������������������������������
             ��                     ��
           YES �� continue        NO �� pass through
                ��
    ������������������������������������������������������������������������������������
    ��  Step 3: Get focused element HWND      ��
    ��  GetGUIThreadInfo() �� hwndFocus        ��
    ������������������������������������������������������������������������������������
                ��
    ������������������������������������������������������������������������������������
    ��  Step 4: Check cached bookmark HWND    ��
    ��  Cache expired? �� Re-resolve (once/2s) ��
    ��  focusedHwnd == cachedBookmarkHwnd?    ��
    ������������������������������������������������������������������������������������
             ��                     ��
        EXACT MATCH           NO MATCH �� pass through
             ��
    ������������������������������������������������������������������������������������
    ��  Step 5: Focus + Send Key              ��
    ��  Dispatcher.Invoke(synchronous):       ��
    ��    1. _focusEditorCallback()           ��
    ��    2. SendKeys.SendWait(keyChar)       ��
    ��  Return (IntPtr)1 (consume key)        ��
    ������������������������������������������������������������������������������������
                ��
    ������������������������������������������������������������������������������������
    ��      Radium Editor Receives Key        ��
    ��         PACS Shortcut Blocked          ��
    ������������������������������������������������������������������������������������
```
...
- **Performance Fix**: `CRITICAL_FIX_2025-11-11_EditorAutofocusBookmarkCaching.md`
- **Key Delivery Fix**: `CRITICAL_FIX_2025-11-11_KeyConsumptionAndDelivery.md`
- **Child Element Fix**: `CRITICAL_FIX_2025-11-11_ChildElementAutofocusPrevention.md`
- **Architecture Reference**: `TECHNICAL_REFERENCE_2025-11-11_KeyboardHookArchitecture.md`
- **Feature Summary**: `SUMMARY_2025-11-11_EditorAutofocusComplete.md`
