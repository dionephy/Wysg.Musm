...
SpyWindow → Custom Procedures → PACS Method: "Send report without header"
...
1. GetText (findings field) → var1
2. IsMatch (var1, "") → var2
3. [If var2="false"] SetValue (findings field, content)
4. SendReportWithoutHeader procedure
5. IsVisible (success indicator) → var3
6. IsMatch (var3, "true") → final result
```
