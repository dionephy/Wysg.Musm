...
?? **Location**: Settings → Reportify → Sentence Formatting  
...
- `number_conclusion_lines_on_one_paragraph` → Shows line-based numbering example
- `capitalize_after_bullet_or_number` → Shows capitalization example
...
**Enable both new options → Expected Output:**
```
1. Apple.
   Banana.
