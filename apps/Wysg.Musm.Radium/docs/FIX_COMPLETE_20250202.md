...
弛  DB ㏒ API ㏒ CACHE (In-Memory) ㏒ Editor Completion      弛
弛              ∟                                           弛
弛              戍式 ApiSnippetServiceAdapter (NEW CACHE)   弛
弛              戍式 ApiHotkeyServiceAdapter (NEW CACHE)    弛
弛              戌式 ApiPhraseServiceAdapter (ALREADY CACHED)弛
