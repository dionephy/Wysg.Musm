...
2. `apps\Wysg.Musm.Radium\Controls\PreviousReportTextAndJsonPanel.xaml.cs`
   - Changed `IsJsonCollapsed` default from `true` ¡æ `false`
...
- `ENHANCEMENT_2025-02-10_RemovePreviousReportJsonToggleButton.md` - Full details
- `ENHANCEMENT_2025-02-09_RemoveJsonToggleButton.md` - Previous similar change for Current Report
