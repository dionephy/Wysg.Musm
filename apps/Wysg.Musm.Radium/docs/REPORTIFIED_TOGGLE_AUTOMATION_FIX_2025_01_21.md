...
### User Requirement
In Settings Window �� Automation tab, when the "Reportify" module runs as part of an automation sequence, the Reportified toggle button in MainWindow �� gridCenter (CenterEditingArea) �� CurrentReportPanel should automatically turn on.
