...
## Change Log Addition (2025-10-07 - FR-269 Dynamic Top/Bottom Heights)
- Added `SubtractNoOffsetConverter` and MultiBindings to bind `gridTop.Height` & `gridBottom.Height` to (Window.ActualHeight - central grid ActualHeight). Mirrors side width pattern.
