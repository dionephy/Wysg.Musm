...
- **T1100** ? Add InvokeOpenWorklist PACS method to AutomationWindow.PacsMethodItems.xaml (FR-1100)
- **T1101** ? Add SetFocusSearchResultsList PACS method to AutomationWindow.PacsMethodItems.xaml (FR-1101)
- **T1102** ? Add SendReport PACS method to AutomationWindow.PacsMethodItems.xaml (FR-1102)
- **T1103** ? Add SetFocus operation to AutomationWindow.OperationItems.xaml (FR-1103)
- **T1104** ? Add WorklistOpenButton, SearchResultsList, SendReportButton to KnownControl enum in UiBookmarks.cs (FR-1107)
- **T1105** ? Add three new KnownControl items to AutomationWindow.KnownControlItems.xaml (FR-1107)
- **T1106** ? Implement SetFocus operation preset configuration in AutomationWindow.Procedures.Exec.cs (FR-1103)
- **T1107** ? Implement SetFocus operation execution in AutomationWindow.Procedures.Exec.cs (FR-1103)
...
- **T1121** ? Manual testing: Verify all three PACS methods appear in AutomationWindow dropdown
...
- **Views**: AutomationWindow.PacsMethodItems.xaml, AutomationWindow.OperationItems.xaml, AutomationWindow.KnownControlItems.xaml, AutomationWindow.Procedures.Exec.cs
...
## Next Steps
1. User tests AutomationWindow to verify all new items appear in dropdowns
