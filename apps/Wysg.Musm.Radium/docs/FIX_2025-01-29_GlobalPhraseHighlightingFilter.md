...
|--------|---------|--------|-------|
| `GetGlobalPhrasesAsync()` | Get global phrases for display | ¡Â3 words | List views |
| `GetCombinedPhrasesAsync()` | Combined list for caching | Global ¡Â3 words, Account all | Initial cache |
| `GetCombinedPhrasesByPrefixAsync()` | Completion window | Global ¡Â3 words, Account all | Dropdown |
...
- FR-completion-filter-2025-01-20: Original completion filter implementation
