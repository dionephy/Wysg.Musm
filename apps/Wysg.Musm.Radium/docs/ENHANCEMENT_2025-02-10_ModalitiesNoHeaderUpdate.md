...
- **Property Changed**: `DoNotUpdateHeaderInXR` (bool) ¡æ `ModalitiesNoHeaderUpdate` (string)
...
1. Open Settings window ¡æ Automation tab
...
Old setting (checkbox checked) ¡æ New setting: Enter "XR" in textbox  
Old setting (checkbox unchecked) ¡æ New setting: Leave textbox empty
