...
|---------|------|---------|
| 1.0 | 2025-02-11 | Initial implementation |
| 1.1 | 2025-02-11 | Bug fix: Added missing event handlers and initialization |
