...
1. User right-clicks existing phrase �� "Link to SNOMED"
...
- [ ] Open phrase extraction window �� select text �� click "Map to SNOMED-CT"
...
- [ ] From phrases management �� right-click phrase �� "Link to SNOMED"
  - [ ] No orange notice (normal mode)
  - [ ] "Map" button is enabled
  - [ ] Can map successfully
- [ ] Complete workflow: extraction �� select text �� map to SNOMED �� save with SNOMED
...
- Related enhancement: ENHANCEMENT_2025-11-06_PhraseExtractionWindowUpdate.md
