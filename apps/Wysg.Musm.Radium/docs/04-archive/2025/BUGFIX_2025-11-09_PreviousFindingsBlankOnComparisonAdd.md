...
**Setup**:
- Current study loaded with 2 previous studies (CT 2025-10-15, MR 2025-01-10)
- Previous studies have finalized reports with proofread fields
- First previous study (CT 2025-10-15) is currently selected
...
[MainViewModel] PreviousStudies.Add(CT 2025-10-15)  ? Toggle buttons reappear
[Prev] SelectedPreviousStudy set -> CT 2025-10-15
