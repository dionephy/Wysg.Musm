...
**Critical Fix**: Added bookmark caching to eliminate performance issues (see CRITICAL_FIX_2025-11-11_EditorAutofocusBookmarkCaching.md)  
...
- **Location**: Settings �� Keyboard tab
- **Controls**:
