...
1. **ENHANCEMENT_2025-11-10_ConditionalSendReportProcedure.md** - Detailed implementation guide
2. **QUICKREF_2025-11-10_ConditionalSendReportProcedure.md** - Quick reference for users
...
Is modality in exclusion list?
    ���� YES �� Execute "SendReportWithoutHeader" custom procedure
    ���� NO  �� Execute "SendReport" custom procedure
        ��
...
### Setting Location
Settings �� Automation Tab �� "Following modalities don't send header" textbox
...
- **Optional:** Configure exclusion list in Settings �� Automation
...
## Related Work
- ENHANCEMENT_2025-11-10_SendReportWithoutHeader.md (SendReportWithoutHeader method)
