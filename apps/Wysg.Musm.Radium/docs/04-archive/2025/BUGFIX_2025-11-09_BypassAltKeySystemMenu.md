...
**Testing:**
- Test Alt key press alone �� should not activate menu system ?
- Test Alt+Up/Down/Left/Right �� should work for navigation ?
- Test Ctrl+Alt+S �� should still open Spy window ?
- Test global hotkeys (Ctrl+Alt+O, Ctrl+Alt+T, Ctrl+Decimal) �� should continue working ?
