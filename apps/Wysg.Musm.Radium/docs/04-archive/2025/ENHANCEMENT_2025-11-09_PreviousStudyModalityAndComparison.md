# Enhancement: Previous Study Modality Extraction & Comparison Update (2025-11-09)
...
4. **Modality Aliases**: Support custom modality aliases (e.g., "MRI" �� "MR", "Xray" �� "XR") in the database
...
## Related Documents
- `apps\Wysg.Musm.Radium\docs\ENHANCEMENT_2025-11-09_AddPreviousStudyComparisonUpdate.md` (original AddPreviousStudy comparison feature)
