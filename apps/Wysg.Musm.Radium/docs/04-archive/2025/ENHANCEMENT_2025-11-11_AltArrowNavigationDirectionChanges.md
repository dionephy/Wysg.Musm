...
### txtStudyRemark
- **Alt+Right** (copyable) �� txtChiefComplaint
- **Alt+Down** �� txtFindings

### txtChiefComplaint
- **Alt+Left** �� txtStudyRemark
- **Alt+Right** �� txtPatientRemark
- **Alt+Down** �� txtPatientHistory

### txtPatientRemark
- **Alt+Left** (copyable) �� txtPatientHistory
- **Alt+Down** �� editorFindings (if TargetEditor is set)

### txtPatientHistory
- **Alt+Up** �� txtChiefComplaint
- **Alt+Down** �� txtFindingsProofread
- **Alt+Left** �� txtStudyRemark
- **Alt+Right** �� txtPatientRemark

### txtFindings
- **Alt+Up** �� txtStudyRemark
- **Alt+Down** �� txtConclusion
- **Alt+Right** (copyable) �� txtFindingsProofread

### txtFindingsProofread
- **Alt+Up** �� txtPatientHistory
- **Alt+Down** �� txtConclusionProofread
- **Alt+Left** �� txtFindings
- **Alt+Right** �� txtPatientRemark

### txtConclusion
- **Alt+Up** �� txtFindings
- **Alt+Down** �� editorFindings (if TargetEditor is set)
- **Alt+Right** �� txtConclusionProofread

### txtConclusionProofread
- **Alt+Up** �� txtFindingsProofread
- **Alt+Down** �� editorFindings (if TargetEditor is set)
- **Alt+Left** �� txtConclusion
- **Alt+Right** �� txtPatientRemark
...
- **Copyable Transitions** - Key transitions that commonly involve text copying are marked as copyable (e.g., Study Remark �� Chief Complaint, Patient Remark �� Patient History, Findings �� Findings PR)
...
User in txtStudyRemark:
  Alt+Right �� txtChiefComplaint (with text copy if selection exists)
  Alt+Down �� txtFindings (focus only)

User in txtChiefComplaint:
  Alt+Left �� txtStudyRemark (focus only)
  Alt+Right �� txtPatientRemark (focus only)
  Alt+Down �� txtPatientHistory (focus only)

User in txtFindings:
  Alt+Up �� txtStudyRemark (focus only)
  Alt+Down �� txtConclusion (focus only)
  Alt+Right �� txtFindingsProofread (with text copy if selection exists)

User in txtFindingsProofread:
  Alt+Up �� txtPatientHistory (focus only)
  Alt+Down �� txtConclusionProofread (focus only)
  Alt+Left �� txtFindings (focus only)
  Alt+Right �� txtPatientRemark (focus only)
```
