...
1. User double-clicks "Basic sequences" �� loads "axial T1", "axial T2"
2. User double-clicks "Contrast sequences" �� loads "CE-T1" (no duplicates)
...
- [ ] V456: Same combination twice �� no duplicates
- [ ] V457: Manual + load with duplicate �� duplicate skipped
...
- [ ] V461: Window resize �� both ListBoxes resize
