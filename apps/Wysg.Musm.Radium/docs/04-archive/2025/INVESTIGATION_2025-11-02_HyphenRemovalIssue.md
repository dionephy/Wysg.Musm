# INVESTIGATION: Hyphen Removal in Report Text (A2-A3 �� A22A3)

**Date**: 2025-11-02  
**Issue**: Hyphens being removed from medical terminology during report sending  
**Example**: "A2-A3" �� "A22A3", "A2?A3" �� "A22A3"  
...
3. **Does the issue occur with raw text (Reportified OFF)?**
   - If NO �� Reportify is the cause
   - If YES �� PACS automation is the cause
...
1. **User Action Required**:
   ...
   - Check character codes in findings text:
     ```
     Open Developer Tools �� inspect `txtFindings.Text`
...
3. **Documentation**:
   ...
   - Add warning in Settings �� Reportify about character normalization
