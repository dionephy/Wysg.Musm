...
### Snapshot Pattern
- The existing snapshot pattern (DB �� snapshot �� UI) is preserved
...
- ? **Clear** - Button text changes ("Add" �� "Update") indicate current mode
...
Action: Select "bll" hotkey �� Edit Selected �� Fix expansion to "bilateral leukoaraiosis" �� Update
After: 
...
Action: Select "chest" snippet �� Edit Selected �� Update template with new medical terms �� Update
After: 
...
Action: Select "noaa" �� Edit Selected �� Add description "normal angio" �� Update
After: 
...
### Edge Cases Covered
- Selecting different item while in edit mode �� New item's data populates fields
- Clicking Cancel �� Fields clear, no database changes
- Updating with empty fields �� Validation prevents save (same as Add)
- Account logout during edit �� Edit mode exits, fields clear
- List refresh after update �� Updated item appears at top
- Multiple rapid updates �� Each update refreshes list correctly
