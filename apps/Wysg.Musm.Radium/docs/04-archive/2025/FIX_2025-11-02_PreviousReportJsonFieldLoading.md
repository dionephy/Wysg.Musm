# Fix: Previous Report JSON Field Loading (2025-11-02)
...
Database JSON (complete)
    ��
Load: Extract 5 fields �� Tab properties
    ��
...
- ? Easy to map wrong source field (e.g., findings �� header_and_findings)
...
```
Database JSON (complete) �� Store in tab.RawJson
    ��
Load: Extract ALL fields �� Tab properties + RawJson
    ��
