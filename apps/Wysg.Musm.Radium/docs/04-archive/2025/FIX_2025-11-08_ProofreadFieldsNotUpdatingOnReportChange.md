...
- User selects "Report A" from ComboBox �� sees proofread fields for Report A
- User changes selection to "Report B" �� proofread fields still show Report A's data ?
...
1. User changes ComboBox selection �� `SelectedReport` property changes
...
**Steps:**
1. Select "Report A"
2. Toggle "Proofread" ON �� verify proofread version shows
3. Change selection to "Report B"
4. Verify "Findings (PR)" shows Report B's proofread data
5. Toggle "Proofread" OFF �� verify original findings show
...
```
[PrevTab] Report selection changed to: CT Chest (2025-10-20 14:30:00) - 2025-10-20 16:45:00 by Dr. Wilson
[PrevTab] ApplyReportSelection: applying report datetime=2025-10-20 16:45:00, findings len=512, conclusion len=234
```

No proofread fields updated �� stale data remains!
