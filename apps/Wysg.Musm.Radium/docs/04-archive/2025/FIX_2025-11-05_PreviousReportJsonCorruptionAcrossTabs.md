...
- `ENHANCEMENT_2025-11-02_PreviousReportSelector.md` - Previous report selection feature
- `FIX_2025-01-30_PreviousStudyConclusionBlankOnAdd.md` - Related previous study bug fix
- `ENHANCEMENT_2025-11-02_PreviousStudyJsonSaveOnTabSwitch.md` - Original (buggy) tab switch save feature
