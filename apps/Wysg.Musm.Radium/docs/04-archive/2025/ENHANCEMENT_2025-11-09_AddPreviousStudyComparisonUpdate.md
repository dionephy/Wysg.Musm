...
**Date**: 2025-11-09  
**Status**: ? Implemented & Updated 2025-11-10
**Build**: Verified
...
**UPDATED BEHAVIOR (2025-11-10)**: The comparison field is now populated with:
...
**Location**: `MainViewModel.Commands.AddPreviousStudy.cs` �� `RunAddPreviousStudyModuleAsync()`
...
**Logic Flow**:
1. Check if `previousStudy` is null �� return early (nothing to update)
...
**Setup**:
- Current study: "CT Chest" (2025-11-09)
- No previous study selected
- User clicks Related Studies list �� selects "CT Chest" (2025-10-15)

**Execution**:
```
1. RunAddPreviousStudyModuleAsync() starts
2. Captures previouslySelectedStudy = null
3. Loads new study "CT Chest" (2025-10-15)
4. Calls UpdateComparisonFromPreviousStudyAsync(null ?? newTab)
   �� Uses newTab since previouslySelectedStudy is null
5. Builds: comparisonText = "CT 2025-10-15"
6. Sets: Comparison = "CT 2025-10-15"
7. Status: "Comparison updated: CT 2025-10-15"
```
...
**Setup**:
- Current study: "CT Chest" (2025-11-09)
- Previous study selected: "CT Chest" (2025-10-15)
- User clicks Related Studies list �� selects "MRI Brain" (2025-11-01)

**Execution**:
```
1. RunAddPreviousStudyModuleAsync() starts
2. Captures previouslySelectedStudy = "CT 2025-10-15"
3. Loads new study "MRI Brain" (2025-11-01)
4. Calls UpdateComparisonFromPreviousStudyAsync(previouslySelectedStudy ?? newTab)
   �� Uses previouslySelectedStudy since it's not null
5. Builds: comparisonText = "CT 2025-10-15"
6. Sets: Comparison = "CT 2025-10-15"
7. Status: "Comparison updated: CT 2025-10-15"
```
...
**Setup**:
- Current study: "XR Chest PA" (2025-11-09)
- DoNotUpdateHeaderInXR = "true"
- Previous study selected: "XR Chest PA" (2025-10-20)
- User loads new previous study

**Execution**:
```
1. Captures previouslySelectedStudy = "XR 2025-10-20"
2. Loads new study successfully
3. Calls UpdateComparisonFromPreviousStudyAsync(previouslySelectedStudy ?? newTab)
4. Checks: StudyName.ToUpperInvariant().StartsWith("XR") �� TRUE
5. Checks: DoNotUpdateHeaderInXR = "true" �� TRUE
6. SKIPS update
...
**Setup**:
- Current study: "XR Chest AP" (2025-11-09)
...
- [x] **First Load**: First previous study loaded �� comparison filled with that study ? FIXED
- [x] **Normal Case**: Non-XR study with existing selection �� comparison updated with previous study info
- [x] **XR with Setting ON**: XR study + DoNotUpdateHeaderInXR="true" �� comparison NOT updated
- [x] **XR with Setting OFF**: XR study + DoNotUpdateHeaderInXR="false" or null �� comparison updated
- [x] **Duplicate Study**: Loading already-loaded study �� comparison still updated
- [x] **Error Handling**: Exception in UpdateComparison �� AddPreviousStudy continues successfully
...
- Settings �� "Do not update header in XR" checkbox
...
- **2025-11-10 Update**: Changed to use null-coalescing operator to ensure first load fills comparison
