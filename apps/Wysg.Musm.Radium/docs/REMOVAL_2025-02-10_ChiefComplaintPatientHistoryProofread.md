...
- [ ] Verify Alt+Arrow navigation works correctly (Study Remark ¡ê Chief Complaint ¡ê Patient Remark ¡ê Patient History)
...
- `ENHANCEMENT_2025-02-02_CollapsibleJsonPanels.md` - JSON panel changes
- `ENHANCEMENT_2025-02-09_RemoveJsonToggleButton.md` - Previous UI simplification
