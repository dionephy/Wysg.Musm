...
```
Grid (3 columns)
戍式式 Column 0: ScrollViewer ⊥ RichTextBox (Left - Original)
戍式式 Column 1: GridSplitter (Resizable)
戌式式 Column 2: ScrollViewer ⊥ RichTextBox (Right - Modified)
```
...
- **Worst case**: O(N昌) for completely different texts (rare)
