# Enhancement: Automation Module Split and Related Studies ID Getter (2025-02-09)
...
### 2. Automation Module Split: UnlockStudy ¡æ UnlockStudy + ToggleOff
...
Added "ToggleOff" to the available modules list in Settings ¡æ Automation:
```csharp
...
This can be done in Settings ¡æ Automation by dragging "ToggleOff" after "UnlockStudy" in sequences that previously used "UnlockStudy" alone.
...
4. `apps\Wysg.Musm.Radium\docs\ENHANCEMENT_2025-02-09_AutomationModuleSplit.md` - This documentation
