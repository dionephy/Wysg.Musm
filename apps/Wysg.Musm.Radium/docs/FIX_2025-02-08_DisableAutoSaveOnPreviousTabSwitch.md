...
When switching between previous study tabs, the application was automatically saving the outgoing tab's JSON changes to its in-memory state. This was implemented as a convenience feature to prevent data loss (see `FIX_2025-02-02_PreviousStudyJsonSaveOnTabSwitch.md`).
...
- `FIX_2025-02-02_PreviousStudyJsonSaveOnTabSwitch.md` - Original auto-save implementation

### Related Issues
- User request 2025-02-08: Disable auto-save on tab switch
- Original issue (2025-02-02): JSON changes lost on tab switch (fixed, now reverted)
