...
弛 [SelectedParts ListBox]                                 弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 Playbook Suggestions                                    弛
戍式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 Playbook        弛 Playbook Parts                        弛
弛 Matches         弛                                       弛
戌式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
```
...
弛 Playbook        弛 Playbook Parts                        弛
弛 Matches         弛                                       弛
戍式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 Mapped Studynames                                       弛
戍式式式式式式式式式式式式式式式式式成式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 Mapped          弛 Mapped Parts                          弛
弛 Studynames      弛                                       弛
弛 (lstMapped-     弛 (shows sequence + part display)       弛
弛 Studynames)     弛                                       弛
戌式式式式式式式式式式式式式式式式式扛式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
```
...
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 1. LoadAsync()                                          弛
弛    戍式式 GetStudynamesAsync()                             弛
弛    戌式式 GetMappedStudynamesAsync()  ∠ NEW                弛
戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎

忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖
弛 User Selects Mapped Studyname                           弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 1. SelectedMappedStudyname property setter              弛
弛 2. LoadMappedStudynamePartsAsync()  ∠ NEW               弛
弛    戍式式 GetPartsAsync()                                  弛
弛    戌式式 GetMappingsAsync(studynameId)                    弛
戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎

忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖
弛 User Double-Clicks Mapped Studyname                     弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 1. OnMappedStudynameDoubleClick()  ∠ NEW                弛
弛 2. Wait for parts to load (async)                       弛
弛 3. SelectedParts.Clear()                                弛
弛 4. Copy all MappedStudynameParts ⊥ SelectedParts        弛
戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎

忙式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式忖
弛 User Saves Mappings                                     弛
戍式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式扣
弛 1. SaveAsync()                                          弛
弛 2. SaveMappingsAsync()                                  弛
弛 3. LoadMappedStudynamesAsync()  ∠ Refresh list          弛
戌式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式式戎
```
