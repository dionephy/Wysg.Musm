...
? "COVID-19" ¡æ Single token  
? "T-cell" ¡æ Single token  
? "X-ray" ¡æ Single token  
? "follow-up" ¡æ Single token  
? "non-small-cell" ¡æ Single token  
...
? Type "COVID-19" ¡æ **Text color changes** (no background)  
? Type "pneumonia" (global phrase) ¡æ **Text turns gray**  
? Type "random text" (not in DB) ¡æ **Text turns red**  
? Type "T-cell" ¡æ **Single word, colored**  
