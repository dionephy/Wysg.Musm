...
namespace Wysg.Musm.Radium.ViewModels
{
    public partial class SettingsViewModel : ObservableObject
    {
        ...
        public SettingsViewModel(IRadiumLocalSettings local, IReportifySettingsService? reportifySvc = null, ITenantContext? tenant = null, PhrasesViewModel? phrases = null, ITenantRepository? tenantRepo = null)
        {
            ...
            // Load DoNotUpdateHeaderInXR from local settings (global setting, not PACS-specific)
            // Must be done AFTER InitializePacsProfileCommands since the property is generated by MVVM Toolkit
            DoNotUpdateHeaderInXR = _local.DoNotUpdateHeaderInXR == "true";
        }
        ...
        private void Save()
        {
            ...
            // NEW: Save DoNotUpdateHeaderInXR to local settings (global setting)
            _local.DoNotUpdateHeaderInXR = DoNotUpdateHeaderInXR ? "true" : "false";
